@if (count($preorder_products) > 0)
    ...
    <section class="mb-2 mb-md-3 mt-2 mt-md-3">
        <div class="container">
            <div class="p-3 p-md-2rem @if(get_setting('featured_section_outline') == 1) border @endif" style="background: {{ $featured_bg != null ? $featured_bg : '#ffffff' }}; border-color: {{ get_setting('featured_section_outline_color') }} !important; padding-bottom: 0 !important;" id="section_preorder_featured_div">
                <!-- Top Section -->
