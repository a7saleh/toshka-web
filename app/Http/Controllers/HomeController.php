...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $homeStyle = get_setting('homepage_select');
        return view('frontend.' . get_setting('homepage_select') . '.index', compact('featured_categories', 'lang','homeStyle'));
    }

    public function showNext($currentHomePage)
    {
        $lang = get_system_language() ? get_system_language()->code : null;
        $featured_categories = Cache::rememberForever('featured_categories', function () {
            return Category::with('bannerImage')->where('featured', 1)->get();
        ...
        $homeStyle = $currentHomePage ?? get_setting('homepage_select');
        ...
        return view('frontend.' . $homeStyle . '.index', compact('featured_categories', 'lang','homeStyle'));
    }
